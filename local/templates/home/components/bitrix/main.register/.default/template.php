...
<? else: ?>
	...
	<? else: ?>
		...
		<div class="site-section">
					...
					<table width="95%">
						<tbody>
													...
													switch ($FIELD) {
														...
														case "WORK_LOGO":
															?><input size="30" type="file"
																name="REGISTER_FILES_<?= $FIELD ?>" class="form-control" /><?
																  break;
														...
														case "WORK_NOTES":
															...
															break;
														default:
															if ($FIELD == "PERSONAL_BIRTHDAY"): ?><small>
							...
							<!-- 							<tr>
												<? // ********************* Radio button ***************************************************?>
								<td colspan="2">
									<div class="row form-group" data-entity="sku-line-block">
										<div class="col-md-12 mb-3 mb-md-0">

											<div>
												<label class="font-weight-bold" for="gender-radio-group">Выберите группу
													пользователей:</label>
											</div>

											<div>
												<input id="radio-1" type="radio" name="gender-radio-group" value="MAN">
												<label class="font-weight-bold" for="radio-1">Покупатель</label>
											</div>

											<div>
												<input id="radio-2" type="radio" name="gender-radio-group" value="WOMAN">
												<label class="font-weight-bold" for="radio-2">Продавец</label>
											</div>
						...
						<tfoot>
							...
							<tr>
								<td colspan="2">
									<noindex><a href="/login/" rel="nofollow">Авторизация</a></noindex><br />
								</td>
							</tr>
						</tfoot>
					</table>
			...
			<p><span class="starrequired">*</span>
				<?= GetMessage("AUTH_REQ") ?>
			</p>
